...
(function(){(function(d,q,p){var g;g=function(){function c(a,b){this.options=d.extend(!0,{},this.Defaults,b);this.$form=d(a);this.$inputs=this.$form.find("input, textarea").filter(this.options.dataAttr);this.submitBtn=d("button[type='submit']");this.$inputs.length&&this.initialize()}c.prototype.Defaults={"class":"mfValidation",dataAttr:"[data-constraints]",constraints:{"@LettersOnly":{rule:"^([a-zA-Z\u0430-\u044f\u0410-\u042f\u0456\u0457\u0451\u0406\u0407\u0401\u0454\u0404\u0490\u0491\\s]{0,})$",
  message:"Please use letters only!"},"@NumbersOnly":{rule:"^-?\\d*\\.?\\d*$",message:"Please use numbers only!"},"@NotEmpty":{rule:/.*\S.*/,message:"Поле должно быть заполнено!"},"@Email":{rule:"^(([\\w-]+(?:\\.[\\w-]+)*)@((?:[\\w-]+\\.)*\\w[\\w-]{0,66})\\.([a-z]{2,6}(?:\\.[a-z]{2})?)){0,}$",message:"Enter valid e-mail address!"},"@Phone":{rule:"^(\\+?\\d{0,3}\\s*\\(?\\d{1,3}\\)?\\s*\\d{3}\\s*\\d{4}){0,}$",message:"Введите правильный номер телефона!"},"@Date":{rule:function(a){return navigator.userAgent.match(/(iPod|iPhone|iPad)/)?
 ...
 * @license      MIT License
 */
!function(o){o.fn.UItoTop=function(n){var e={text:"",min:500,scrollSpeed:800,containerID:"on-top",containerClass:"ui-to-top fa fa-angle-up",easingType:"easeIn"},t=o.extend(e,n),i="#"+t.containerID;o("body").append('<a href="#" id="'+t.containerID+'" class="'+t.containerClass+'" >'+t.text+"</a>"),o(i).click(function(){return o("html, body").stop().animate({scrollTop:0},t.scrollSpeed,t.easingType),!1}),o(window).scroll(function(){var n=o(window).scrollTop();"undefined"==typeof document.body.style.maxHeight&&o(i).css({position:"absolute",top:o(window).scrollTop()+o(window).height()-50}),n>t.min?o(i).stop(!0,!0).addClass("active"):o(i).removeClass("active")})}}(jQuery);
