module AdminHelper
  ...
  def link_to_add_interval_fields(name, f, association, partial_path=nil, **args)
    ...
    link_to(name, '#', class: 'add_interval_fields ' + args[:class], data: {id: id, fields: fields.gsub("\n", "")})
  end
